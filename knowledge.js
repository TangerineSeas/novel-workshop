const KNOWLEDGE_DATA = [
  ...
  // ========== 经典武器与装备 ==========
  {
    ...
    subcategory: "装备/武器",
    title: "奇幻世界中的经典武器",
    content: "奇幻设定中的武器体系通常以中世纪欧洲的真实武器为蓝本，并赋予其魔法属性或传说背景。常见的幻想武器包括：长剑（骑士的标准武器，常被赋予神圣,火焰等属性）、双手巨剑（重装战士使用，需要极大力量）、战斧（矮人偏好武器）、长弓（精灵或游侠的远程武器）、匕首（盗贼或刺客的潜行武器）、战锤（对重甲敌人有效）。传奇武器则通常具有独特名称和来历——如斩杀恶龙的剑、由神祇锻造的矛，或封印了古代法师力量的魔杖。",
    references: ["幻想世界史研究会《奇幻世界大百科》，2016年，枫树林出版"]
  }
];
