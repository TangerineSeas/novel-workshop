const KNOWLEDGE_DATA = [
    ...
    // ========== 信仰与宇宙架构 ==========
  {
    ...
    subcategory: "信仰/宇宙",
    title: "中世纪基督教宇宙观",
    content: "中世纪基督教宇宙观是古希腊宇宙论与《创世记》叙事的综合产物。中世纪神学家致力于将亚里士多德的天体理论与圣经的创世故事统一起来。在这一宇宙图景中，地球位于宇宙中心，周围环绕着月球、水星、金星、太阳、火星、木星和土星等行星天层，最外层是恒星天。宇宙之外是"至高天"（Empyrean），即上帝和蒙福者的居所。这一综合体系在16至18世纪逐渐被无限宇宙和日心说等新观念所解构。",
