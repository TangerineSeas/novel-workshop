const KNOWLEDGE_DATA = [
    ...
    // ========== 怪物与奇异生物 ==========
  {
    ...
    subcategory: "奇幻/文化",
    title: "中世纪的怪物文化",
    content: "中世纪欧洲人深信怪物真实存在于世界的边缘地带。在当时人们的认知中，幻想与现实的界限并不清晰，人与动物的混合体、扭曲变形的人体、自然界万物在外形上的交流转换都被视为可能发生的事。这种怪物信仰源于古典时代的博物学传统和基督教对"上帝造物多样性"的理解——既然上帝是全能的，他创造出半人半兽的生物也是完全合理的。怪物成为中世纪想象力的最大宝藏，至今仍是奇幻文学和影视创作取之不尽的素材库。",
